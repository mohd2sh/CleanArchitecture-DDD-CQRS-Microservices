...
namespace Assets.Service.Application.Assets.Events.WorkOrderCompletionRequested;
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (asset is null)
            {
                ...
                throw new CleanArchitecture.Core.Application.Abstractions.Common.ApplicationException(AssetErrors.NotFound);
            }
