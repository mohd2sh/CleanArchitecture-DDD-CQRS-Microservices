...
using Assets.Service.Application;
using Assets.Service.Infrastructure;
...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting up Assets Service API");
            ...
            Log.Information("Assets Service API started successfully");
