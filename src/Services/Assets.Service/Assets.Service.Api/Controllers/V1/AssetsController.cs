...
using Assets.Service.Api.Controllers.V1.Requests.Assets;
using Assets.Service.Application.Assets.Commands.CreateAsset;
using Assets.Service.Application.Assets.Commands.UpdateAssetLocation;
using Assets.Service.Application.Assets.Dtos;
using Assets.Service.Application.Assets.Queries.GetActiveAssets;
using Assets.Service.Application.Assets.Queries.GetAssetById;
using CleanArchitecture.Core.Application.Abstractions.Common;
using CleanArchitecture.Core.Application.Abstractions.Messaging;
using CleanArchitecture.Core.Application.Abstractions.Query;
using Microsoft.AspNetCore.Mvc;

namespace Assets.Service.Api.Controllers.V1;
