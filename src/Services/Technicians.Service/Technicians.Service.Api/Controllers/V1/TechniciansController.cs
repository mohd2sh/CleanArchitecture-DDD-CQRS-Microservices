...
using Technicians.Service.Api.Controllers.V1.Requests.Technicians;
using Technicians.Service.Application.Technicians.Commands.AddCertification;
using Technicians.Service.Application.Technicians.Commands.CreateTechnician;
using Technicians.Service.Application.Technicians.Commands.SetAvailable;
using Technicians.Service.Application.Technicians.Commands.SetUnavailable;
using Technicians.Service.Application.Technicians.Dtos;
using Technicians.Service.Application.Technicians.Queries.GetAvailableTechnicians;
using Technicians.Service.Application.Technicians.Queries.GetTechnicianById;
using CleanArchitecture.Core.Application.Abstractions.Common;
using CleanArchitecture.Core.Application.Abstractions.Messaging;
using CleanArchitecture.Core.Application.Abstractions.Query;
using Microsoft.AspNetCore.Mvc;

namespace Technicians.Service.Api.Controllers.V1;
