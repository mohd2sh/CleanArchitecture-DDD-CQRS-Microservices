...
namespace Technicians.Service.Application.Behaviors;

internal sealed class TransactionCommandPipeline<TCommand, TResult> : ICommandPipeline<TCommand, TResult>
