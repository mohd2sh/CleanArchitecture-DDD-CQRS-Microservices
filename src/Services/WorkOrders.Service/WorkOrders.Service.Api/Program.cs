...
using Serilog;
using WorkOrders.Service.Application;
using WorkOrders.Service.Infrastructure;

namespace WorkOrders.Service.Api;
...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting up WorkOrders Service API");
            ...
            Log.Information("WorkOrders Service API started successfully");
